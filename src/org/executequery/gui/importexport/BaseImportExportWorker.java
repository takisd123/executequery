...
*/
    protected void outputExceptionError(String message, Throwable e) {
        ...
        if (e instanceof DataSourceException) {
            ...
            outputBuffer.append(bundledString(
    ...
    protected void printResults() {
        ...
        if (ImportExportResult.isSuccess(importExportResult)) {
            ...
            sb.append(bundledString("AbstractImportExportWorker.processCompletedSuccessfully"));

        } else if (ImportExportResult.isCancelled(importExportResult)) {
            
            sb.append(bundledString("AbstractImportExportWorker.processCancelled"));

        } else if (ImportExportResult.isFailed(importExportResult)) {
          
            sb.append(bundledString("AbstractImportExportWorker.processCompletedWithErrors"));
        }

        sb.append(bundledString("AbstractImportExportWorker.totalDuration"));
        sb.append(getFormattedDuration());
        sb.append(bundledString("AbstractImportExportWorker.totalTablesProcessed"));
        sb.append(tableCount);
        sb.append(bundledString("AbstractImportExportWorker.totalRecordsProcessed"));
        sb.append(recordCount);
        sb.append(bundledString("AbstractImportExportWorker.totalRecordsTransferred"));
        sb.append(recordCountProcessed);
        sb.append(bundledString("AbstractImportExportWorker.errors"));
    ...
    protected void printExportFileSize(ImportExportFile importExportFile) {
        ...
        sb.append(bundledString("AbstractImportExportWorker.outputFileName"));
        sb.append(importExportFile.getFile().getName());
        
        long fileSize = importExportFile.getFile().length();
        
        sb.append(bundledString("AbstractImportExportWorker.outputFileSize"));
    ...
    protected final String bundledString(String key, Object...args) {
