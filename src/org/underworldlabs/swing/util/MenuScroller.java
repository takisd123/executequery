...
// from https://tips4java.wordpress.com/2009/02/01/menu-scroller/
...
public class MenuScroller {
    ...
    private void refreshMenu() {
        if (menuItems != null && menuItems.length > 0) {
            ...
            firstIndex = Math.min(
                    menuItems.length - bottomFixedCount - scrollCount,
                    firstIndex);
            ...
            for (int i = menuItems.length
                    - bottomFixedCount; i < menuItems.length; i++) {
                menu.add(menuItems[i]);
            }
        ...
        private void setMenuItems() {
            ...
            if (keepVisibleIndex >= topFixedCount
                ...
                firstIndex = Math.max(firstIndex,
                        keepVisibleIndex - scrollCount + 1);
            }
